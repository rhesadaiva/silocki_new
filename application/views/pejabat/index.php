							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									<div class="award-item">
										...
										<h3 style="margin-bottom: -10px"><b><?= $jumlahbawahan; ?></b></h3>
										<br>
										<span>Total Bawahan Aktif</span>
									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<div class="award-item">
										...
										<h3 style="margin-bottom: -10px"><b><?= $kkbelumdiapprove; ?></b></h3>
										<br>
								...
								<div class="col-md-3 col-sm-6">
									<div class="award-item">
										...
										<h3 style="margin-bottom: -10px"><b><?= $ikubelumdiapprove; ?></b></h3>
										<br>
										<span>Total IKU</span>
									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<div class="award-item">
										...
										<h3><b><?= $logbookbelumdiapprove; ?></b></h3>
